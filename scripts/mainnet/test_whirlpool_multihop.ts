...
import { PublicKey, Keypair, SystemProgram, Connection, Transaction, VersionedTransaction, AddressLookupTableProgram } from "@solana/web3.js";
import {
    TOKEN_PROGRAM_ID,
...
const WHIRLPOOL_1 = new PublicKey("BofA2ViUSudPBTUms2KRuG6AHNeMawjNfwqTJDgx5BKW");
const POOL_INFO_1 = new PublicKey("4EcJMTCubP3NNF8XxWQbpfBHUmp9xM5QkcjPtW2JAEXa");
const TICK_ARRAY_0_1 = new PublicKey("8EV1x6gWz3eXzJzekmKGo1tnds6JWNJRriHi8JywZX3E");
const TICK_ARRAY_1_1 = new PublicKey("ECX85P5RzQfCV8jW3VuPAncnckkViEBgXuyhqCn3aSNo");
const TICK_ARRAY_2_1 = new PublicKey("Es2kN9ZRTXGRTKuDhXPw7yqEd5ytJEV1qpi58VgfNPh5");
const ORACLE_1 = new PublicKey("9UXyKABdsimsf8qz4BLxP3d4QaL6rDQLbnMYBhjL6y8d");
const TOKEN_VAULT_A_1 = new PublicKey("BkSYpPsv11UPDLonxBZf2mFndfuN2MrDwYt4gjDEnk8D");
const TOKEN_VAULT_B_1 = new PublicKey("2wcLHj441NnqiUon4LcmMo6dGAUqwEW84nfFKnfuTnPt");

// Step 1: PUMP -> USDC (Whirlpool V2) - THIS IS WHERE THE ERROR OCCURS
const WHIRLPOOL_2 = new PublicKey("DjJVnaiJYFjb76m4B4tdVJjxqyhRpb9yjjtCag5hbM2N");
const POOL_INFO_2 = new PublicKey("9HdTTBzVTnmgSwBE1T3bAhj6FW54nqUZy71j5Rm46s1c");
const TICK_ARRAY_0_2 = new PublicKey("6NBVKRprS3tRLJbzjwsudhG6wyCeZcAKuDQE4kEM5THt");
const TICK_ARRAY_1_2 = new PublicKey("AmKR35tU6GG7Lx4h4dwWqukSmgHwsLJhXQ75yz2bge7c");
const TICK_ARRAY_2_2 = new PublicKey("6R2C4iaa3PcG9RYtk4ZDMkDcLYimw8YepjxJ8khY21bU");
const ORACLE_2 = new PublicKey("83WWULZaHbjby5kx6tf7u5ecKiEK87nEDWqRtaUEZA8k");
const TOKEN_VAULT_A_2 = new PublicKey("Ep1tN5xnXxJXxLbHQgFoPqFLtfk22LWtbtiywLr7PzM5");
const TOKEN_VAULT_B_2 = new PublicKey("139uvUuFK8F4msmrhdVcpBvzPapEKfc8G6FCuaXkWdNP");

// Step 2: USDC -> ORCA (Whirlpool V1)
const WHIRLPOOL_3 = new PublicKey("5Z66YYYaTmmx1R4mATAGLSc8aV4Vfy5tNdJQzk1GP9RF");
const POOL_INFO_3 = new PublicKey("F3QK459DeMJzhWtfhnuaf4WZGxEQusZKnMv3ka1mdhbV");
const TICK_ARRAY_0_3 = new PublicKey("7pTLnNa84sgav2qeU3vNbf6R9a9CcKrHdwJg5jihaHhx");
const TICK_ARRAY_1_3 = new PublicKey("6Kt8Ss5C1MruKNVZVkr7TztnJ8PGTaPySMgfaDNSNevi");
const TICK_ARRAY_2_3 = new PublicKey("CvKbGH2WJoQXsohf1SxT4c9he7RrsKAF8TSZifyJbuuM");
const ORACLE_3 = new PublicKey("GXcffFhSX1eq6Xq1iFhQMYDpNokHMvbuGV8etg6XQLiu");
const TOKEN_VAULT_A_3 = new PublicKey("AGsWEmKndNhRbSFWtrcDVrsxfoM71j8pVmvGuEwJX8a1");
const TOKEN_VAULT_B_3 = new PublicKey("2kSYyDFRQpWaouveza4JbyGKBVtd3im8E6wQnPYiwgH9");

const PLATFORM_FEE_ACCOUNT = new PublicKey("3Ahw4EGFeq1oVa882GNisGYDVn8667qbrAu9tg9sJmJ3");
...
async function main() {
    ...
    try {
        ...
        const wsolAccountInfo = await getAccount(connection, userSourceTokenAccount);
        console.log("   ✓ User Source Token Account (WSOL) exists:", userSourceTokenAccount.toBase58());
        ...
        console.log("   ✓ User Source Token Account (WSOL) created:", userSourceTokenAccount.toBase58());
    }
    ...
    try {
        ...
        const orcaAccountInfo = await getAccount(connection, userDestinationTokenAccount);
        console.log("   ✓ User Destination Token Account (ORCA) exists:", userDestinationTokenAccount.toBase58());
        ...
        console.log("   ✓ User Destination Token Account (ORCA) created:", userDestinationTokenAccount.toBase58());
    }
    console.log();

    // Vault accounts from the log (already exist)
    // [0] Input Vault (WSOL)
    const inputVault = new PublicKey("A4LX43GLT2cmu2vubqZbVp93Nn5awYyG9CUs2TBd6tWG");
    // [17] Intermediate Vault 1 (PUMP) - output of step 0, input of step 1
    const intermediateVault1 = new PublicKey("ByDNvRjARxzvS9CE8kYTWJmobZ9VA34nR3CyopLhEx7e");
    // [35] Intermediate Vault 2 (USDC) - output of step 1, input of step 2
    const intermediateVault2 = new PublicKey("BuDCga2qoU2Ny4PC4w1d3cBcQ87e459AsSP2gotBsNTZ");
    // [53] Output Vault (ORCA) - output of step 2
    const outputVault = new PublicKey("A7pXj1YWvrS4qsGzjTHQ8unPSibrEPA3mYVvxWhKwuct");
    ...
    // Step 0: SOL -> PUMP
    const tokenOwnerAccountA1 = new PublicKey("91bUbswo6Di8235jAPwim1At4cPZLbG2pkpneyqKg4NQ"); // WSOL vault
    const tokenOwnerAccountB1 = new PublicKey("C4rYb1s9Rbn4ndZT4qxRk1bgsCdcZnSkmL8WgzuRSMUz"); // PUMP vault

    // Step 1: PUMP -> USDC
    const tokenOwnerAccountA2 = new PublicKey("C4rYb1s9Rbn4ndZT4qxRk1bgsCdcZnSkmL8WgzuRSMUz"); // PUMP vault
    const tokenOwnerAccountB2 = new PublicKey("Gjmjory7TWKJXD2Jc6hKzAG991wWutFhtbXudzJqgx3p"); // USDC vault

    // Step 2: USDC -> ORCA
    const tokenOwnerAccountA3 = new PublicKey("HxWUAKCojAhvkNZRy2X4cqkKeMUyYcvDmZsvWkzJYUQs"); // USDC vault
    const tokenOwnerAccountB3 = new PublicKey("Gjmjory7TWKJXD2Jc6hKzAG991wWutFhtbXudzJqgx3p"); // ORCA vault
    ...
    for (const [poolInfo, poolAddress, swapType] of poolInfosToCheck) {
        try {
            const poolInfoAccount = await (flipperProgram.account as any).poolInfo.fetch(poolInfo);
            ...
            if (e.message && e.message.includes("Account does not exist")) {
                console.log(`   ⚠️  PoolInfo ${poolInfo.toBase58()} does not exist, initializing...`);
                try {
    ...
    routePlan.forEach((step, idx) => {
        console.log(`   Step ${idx}: swap=${JSON.stringify(step.swap)}, input_index=${step.inputIndex}, output_index=${step.outputIndex}, percent=${step.percent}`);
    });
    console.log();

    console.log("📋 Remaining Accounts:", remainingAccounts.length);
    remainingAccounts.forEach((acc, idx) => {
        console.log(`   [${idx}] ${acc.pubkey.toBase58()} (writable: ${acc.isWritable}, signer: ${acc.isSigner})`);
    });
    console.log();
    ...
    if (initialWsolBalance < BigInt(inAmount.toString())) {
        ...
        if (solBalance < Number(solNeeded)) {
            throw new Error(`Insufficient SOL balance. Need ${solNeeded.toString()} lamports, have ${solBalance}`);
        }
        ...
        const syncNativeInstruction = createSyncNativeInstruction(userSourceTokenAccount);

        const wrapTx = new Transaction().add(transferInstruction).add(syncNativeInstruction);
        ...
        const updatedWsolAccount = await getAccount(connection, userSourceTokenAccount);
    ...
    try {
        ...
        const lookupTables = await Promise.all(
            addressLookupTables.map(async (altAddress) => {
                ...
                if (!altAccountInfo.value) {
                    throw new Error(`Address Lookup Table ${altAddress.toBase58()} not found`);
                }
        ...
        const finalWsolBalance = (await getAccount(connection, userSourceTokenAccount)).amount;
        const finalOrcaBalance = (await getAccount(connection, userDestinationTokenAccount)).amount;
